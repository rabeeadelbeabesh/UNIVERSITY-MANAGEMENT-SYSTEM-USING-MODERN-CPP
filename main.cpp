...
/*
//shared_ptr<Course>Course1 = make_shared<Course>();
	//shared_ptr<Course>Course2 = make_shared<Course>();
	//shared_ptr<Course>Course3 = make_shared<Course>();
	//Course1->setId(1); Course1->setName("math"); Course1->setHourse(2);
	//Course2->setId(2); Course2->setName("dataStrcture"); Course2->setHourse(3);
	//Course3->setId(3); Course3->setName("algorthm"); Course3->setHourse(2);


	//shared_ptr<Student>Student1 = make_shared<Student>();
	//shared_ptr<Student>Student2 = make_shared<Student>();
	//shared_ptr<Student>Student3 = make_shared<Student>();
	//Student1->setId(1); Student1->setName("Rabee"); Student1->setUserName("Rabee123"); Student1->setAge(24); Student1->setGPA(3.24); Student1->setPhoneNumber("01095798494");
	//Student1->addCourse(1); Student1->addCourse(3);

	//Student2->setId(2); Student2->setName("Ahmed");  Student2->setUserName("Ahmed123"); Student2->setAge(33); Student2->setGPA(1.24); Student2->setPhoneNumber("01195798494");
	//Student2->addCourse(1);

	//Student3->setId(3); Student3->setName("Mohamed"); Student3->setUserName("Mohamed123"); Student3->setAge(19); Student3->setGPA(3.24); Student3->setPhoneNumber("01295798494");
	//Student3->addCourse(2); Student3->addCourse(3);


	//shared_ptr<Teacher>Teacher1 = make_shared<Teacher>();
	//shared_ptr<Teacher>Teacher2 = make_shared<Teacher>();
	//shared_ptr<Teacher>Teacher3 = make_shared<Teacher>();
	//Teacher1->setId(1); Teacher1->setName("mo"); Teacher1->setUserName("mo222"); Teacher1->setAge(50); Teacher1->setSalsry(32140); Student1->setPhoneNumber("01095798494");
	//Teacher1->addCourse(1); Teacher1->addCourse(2); Teacher1->addCourse(3);
	//Teacher2->setId(2); Teacher2->setName("khalewl"); Teacher2->setUserName("khalewl444"); Teacher2->setAge(60); Teacher2->setSalsry(11240); Student2->setPhoneNumber("01195798494");
	//Teacher2->addCourse(1);  Teacher2->addCourse(3);
	//Teacher3->setId(3); Teacher3->setName("mosa"); Teacher3->setUserName("mosa888"); Teacher3->setAge(70); Teacher3->setSalsry(13240); Student3->setPhoneNumber("01295798494");
	//Teacher3->addCourse(2); Teacher3->addCourse(3);


	//shared_ptr<AdminDM>adminDM = make_shared<AdminDM>();

	//adminDM->addStudent(Student1);
	//adminDM->addStudent(Student2);
	//adminDM->addStudent(Student3);


	//adminDM->addTeacher(Teacher1);
	//adminDM->addTeacher(Teacher2);
	//adminDM->addTeacher(Teacher3);


	//adminDM->addCourse(Course1);
	//adminDM->addCourse(Course3);
	//adminDM->addCourse(Course2);

	//cout << "Done!";

	/*std::shared_ptr<verifyUser>theVerifyUser = std::make_shared<verifyUser>();
	shared_ptr<Student>theStudent = theVerifyUser->verifyStudenttUser("Rabee123");
	if (theStudent!=nullptr) {
		cout << "accept\n";
	}
	else cout << "not found\n";
	shared_ptr<StudentDM>theStudentDm = make_shared<StudentDM>(theStudent->getId());
	std::vector<shared_ptr<Course>> courses = theStudentDm->getMYCourses();
